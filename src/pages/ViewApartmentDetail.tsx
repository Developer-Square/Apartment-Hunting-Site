  ...
  return (
    <section className="body-background w-full h-full text-white">
      ...
      <ErrorBoundary>
        {aboutApartmentModal ? (
          <AboutApartmentModal
            setAboutApartmentModal={setAboutApartmentModal}
          />
        ) : null}
      </ErrorBoundary>
      <ErrorBoundary>
      ...
      <ErrorBoundary>
        {showConfirmAndPayModal ? (
          <ConfirmAndPayModal
            setConfirmAndPayModal={setShowConfirmAndPayModal}
          />
        ) : null}
      </ErrorBoundary>
      {/* Navbar */}
            ...
            <div className="md:flex w-full justify-between">
              ...
              <div className="hidden md:flex justify-between">
                <div className="flex mr-5 cursor-pointer items-center">
                  ...
                  <p className="underline underline-offset-1 xl:text-sm">
                    Share
                  </p>
                </div>
                <div
              ...
              <div>
                ...
                <div className="flex flex-col">
                  <p className="text-base xl:text-sm">
                    Centrally located at the heart of Kilimani, a few minutes
                    walk or drive to major shopping center's( Yahya, Junction
                    Mall), famous eateries and the main landmarks of Nairobi, is
                    the The View at Heartland. This apartment combines modern
                    finishes...{" "}
                  </p>
                  <div
          ...
          <ErrorBoundary>
            <div>
              <div className="border-white/[.4] border mb-6 rounded-lg w-full xl:w-[65%] py-3 px-4 xl:text-sm">
                82% of similar properties in Kilimani with 2 bedrooms have a
                lower asking price.
